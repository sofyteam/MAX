...
info = '💬┇بواسطه ⌁≻ ['..result.first_name_..'](t.me/'..(result.username_ or 'SOFYTEAM')..')\n'..text
...
info = '👨┇العضو ⌁≻ ['..result.first_name_..'](t.me/'..(result.username_ or 'SOFYTEAM')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
info = '👨┇العضو ⌁≻ ['..(result.first_name_ or value)..'](t.me/'..(result.username_ or 'SOFYTEAM')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
texts = '👨┇العضو ⌁≻ ['..result.title_..'](t.me/'..(apow[2] or 'SOFYTEAM')..')\n☑┇تم رفع منشئ في البوت'
else
texts = '✖┇خطاء'
end
...
os.execute('cd libs && wget https://raw.github.com/SOFYTEAM/MAX/master/libs/utils.lua')
os.execute('rm -rf MAX.lua')
os.execute('wget https://raw.github.com/SOFYTEAM/MAX/master/MAX.lua')
os.exit()
return false
end
...
texts = '👨┇العضو ⌁≻ ['..result.title_..'](t.me/'..(apmd[2] or 'SOFYTEAM')..')\n☑┇تم رفعه ادمن'
else
texts = '✖┇خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
texts = '👨┇العضو ⌁≻ ['..result.title_..'](t.me/'..(apba[2] or 'SOFYTEAM')..')\n☑┇تم حظره من المجموعه'
...
local hash =  'MAX:'..bot_id..'gbanned:'
texts = '👨┇العضو ⌁≻ ['..result.title_..'](t.me/'..(apbll[2] or 'SOFYTEAM')..')\n🚫┇تم حظره من المجموعات البوت'
...
local hash =  'MAX:'..bot_id..'gbanned:'
if result.id_ then
texts = '👨┇العضو ⌁≻ ['..result.title_..'](t.me/'..(apid[2] or 'SOFYTEAM')..')\n🚫┇تم الغاء حظره من المجموعات البوت'
database:srem(hash, result.id_)
else
texts = '✖┇خطاء'
end
...
texts = '👨┇العضو ⌁≻ ['..result.title_..'](t.me/'..(apsi[2] or 'SOFYTEAM')..')\n🚫┇تم كتمه من البوت'
end
else
texts = '✖┇خطاء'
end
...
texts = '👨┇العضو ⌁≻ ['..result.title_..'](t.me/'..(apki[2] or 'SOFYTEAM')..')\n🚫┇تم طرده من المجموعه'
chat_kick(msg.chat_id_, result.id_)
end
else
texts = '✖┇خطاء'
...
👋🏼 ¦ اهـلاً عزيـزي🍂
➖➖➖➖➖➖➖➖➖➖➖➖
🔻 ¦ الــسـورس خـاص بـالـبـوت 
➖➖➖➖➖➖➖➖➖➖➖➖
▪️ ¦ راسـل مـطـور الـسـورس @K5R_2
➖➖➖➖➖➖➖➖➖➖➖➖
🔺 ¦ قـنـاة الـمـطـور @YR_IQ
]]
send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
end
